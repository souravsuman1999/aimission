...
;
const metadata = {
    title: "AI Mission - Practical AI for Indian Institutions",
    description: "AI Mission designs practical AI training and systems for Indian schools, colleges, and businesses. Clear use-cases, working workflows, and measurable results.",
    generator: "v0.app",
    icons: {
        icon: [
            {
